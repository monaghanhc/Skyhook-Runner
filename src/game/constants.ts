...
export const JUMP_VELOCITY = 13.9;
export const SLIDE_DURATION = 0.65;
export const LANE_SWITCH_TIME = 0.12;
...
export const SPEED_RAMP_PER_SEC = 0.032;
export const CHUNKS_AHEAD = 5;
export const CHUNKS_BEHIND = 2;
/** Slightly forgiving window when gaps unlock */
export const GRAPPLE_RANGE_Z = 7.8;
/** Allow late grapples shortly after passing an anchor */
export const GRAPPLE_LATE_TOLERANCE_Z = 3.6;
export const GRAPPLE_DURATION = 1.02;
